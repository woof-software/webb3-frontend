...
export type SwapQuote = {
  ...
  /**
   * The commissions taken by the Compound platform. Commissions are extracted from the initial amount, so we
   * do not need to make additional adjustment as usual. Retrieved value is the percentage in range of 0 ... 100. 
   */
