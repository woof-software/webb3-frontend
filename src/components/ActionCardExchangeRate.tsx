...
import { ExchangeArrows } from '@components/Icons';
import { PulseLoader } from '@components/PulseLoader';
import { formatToken } from '@helpers/format';

export interface ActionCardExchangeRateProps {
  title: string;
...
export const ActionCardExchangeRate = (props: ActionCardExchangeRateProps) => {
  const {
    title,
    isQuoteExists,
    isFetching,
