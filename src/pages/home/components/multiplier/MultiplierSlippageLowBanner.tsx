...
export const MultiplierSlippageLowBanner = () => {
  const { data: quote } = useMultiplierQuote();

  const { slippagePercent, setSlippagePercent } = MultiplierContext.use();
  ...
  return (
    <WarningAlert className={'multiplier-slippage-low-alert'}>
