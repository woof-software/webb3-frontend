...
export default function CollateralSwapInput(props: CollateralSwapInputProps) {
  const {
    symbol,
    value,
    error,
  ...
  return (
    <div
      className="collateral-swap-input"
    ...
    >
      ...
      {isBaseAssetOnSwap &&
        <WarningAlert
          className={'collateral-swap-action-card__alert'}
          onClick={(e) => e.stopPropagation()}
        >Leftovers will be returned in the base asset if the collateral amount is more than the loan.</WarningAlert>
      }
    </div>
  );
}
